...
const AiPredictionFooter: React.FC = () => {
    ...
    return (
        <footer className="bg-[#05020a] border-t border-purple-500/10 pt-20 pb-10 relative overflow-hidden">
            {/* Glow Effects */}
            <div className="absolute top-0 left-1/4 w-96 h-96 bg-purple-900/10 rounded-full blur-[128px] pointer-events-none"></div>
                ...
                <div className={`grid ${pathname === "/" ? "md:grid-cols-4" : "md:grid-cols-3"} gap-12 mb-16`}>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex gap-4">
                            {[FaTwitter, FaDiscord, FaTelegram, FaLinkedin].map((Icon, i) => (
                                <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-purple-500/20 flex items-center justify-center text-gray-400 hover:text-purple-400 transition-all border border-white/5 hover:border-purple-500/30">
                                    <Icon size={18} />
                                </a>
                            ))}
                        </div>
                    ...
                    {pathname === "/" && <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-400">
                            <li><button onClick={() => document.getElementById('hero')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-purple-400 transition-colors">Overview</button></li>
                            ...
                            <li><button onClick={() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-purple-400 transition-colors">Pricing</button></li>
                            <li><button onClick={() => document.getElementById('demo')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-purple-400 transition-colors">Demo</button></li>
                        </ul>
                    </div>}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-400">
                            ...
                            <li><Link to="/risk-disclaimer" className="hover:text-purple-400 transition-colors">Risk Disclaimer</Link></li>
                        </ul>
                    </div>
                </div>
